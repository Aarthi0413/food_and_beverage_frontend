  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 w-full h-full z-10 flex justify-between items-center bg-slate-200 bg-opacity-50">
      <div className="mx-auto bg-white shadow-md p-4 w-full max-w-sm">
        ...
        <h1 className="pb-4 text-md font-medium">Change User Role</h1>

        <p className="pb-2 text-md">Name : {name}</p>
        ...
        <button
          className="w-fit mx-auto block py-1 px-3 rounded-full bg-orange-400 text-white hover:bg-orange-500"
